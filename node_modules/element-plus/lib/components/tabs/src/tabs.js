  ...
  setup(props, { emit, slots, expose }) {
    ...
    const updatePaneInstances = (isForceUpdate = false) => {
      if (slots.default) {
        ...
        const panesChanged = !(paneInstanceList.length === panes.value.length && paneInstanceList.every((pane, index) => pane.uid === panes.value[index].uid && !pane.instance.slots.label));
